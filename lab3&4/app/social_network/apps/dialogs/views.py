...
def post(request, username):
    ...
    if messages:
        logger.info('success queri messages')
        return HttpResponse(
            json.dumps({
                "result": True,
        ...
        logger.warning('not success queri messages')
        return HttpResponse(
            json.dumps({
                "result": False,
            }),
...
def leave_message(request, reciever_name):
    ...
    if messages:
        ...
        logger.warning('not send messages')
        return HttpResponse(
            json.dumps({
                "result": False,
            }),
...
def delete_dialog(request, companion_id):
    try:
        ...
        logger.error('no user conversation')
